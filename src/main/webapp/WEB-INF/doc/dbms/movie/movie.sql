...
COMMENT ON COLUMN movie.openDt is '개봉날짜';
...
select movieCd
from movie
where movieno BETWEEN 1 AND 100

-- 영역별 검사
 select movieno, movieCd, showTm, watchGradeNm, actors
 from movie
 where movieno BETWEEN 49201 AND 55200
