...
<div class="bocoffice_rank" style="height: 326px;">
  <div style="margin: 5px;">
    ...
    <hr style="margin-top: 5px; margin-bottom: 17px;">
  <c:forEach var="mainBoxOfficeVO" items="${list }">
    <div style="margin: 5px; ">
      <span class="span_rank">&nbsp;${mainBoxOfficeVO.rank}&nbsp;</span> 
       <A href="javascript:movie_detail(${mainBoxOfficeVO.movieCd})"><span style="font-size: 13px; ">${mainBoxOfficeVO.movieNm}</span></A>
       <br>
    </div>
  </c:forEach>
</div>
